...
export function buildTutorialSteps(): TutorialStep[] {
  ...
  return [
    ...
    },
    {
      ...
      textMobile: [
        'Пять человек находились в агентстве в момент преступления. Нужно восстановить, кто где стоял.',
        'Подсказки-улики — в списке снизу. Расставьте всех по местам и нажмите «Проверить».',
      ],
      target: { kind: 'none' },
      advance: { kind: 'next' },
    },
    ...
    },
    {
      ...
      textMobile: [
        'Снизу — список всех участников дела. У каждого подозреваемого — свои улики: это ваши зацепки.',
        'Кликните по человеку в списке — так вы берёте его «в руку», чтобы поставить на поле. Попробуйте: выберите Андрея.',
      ],
    ...
    },
    {
      ...
      text: [
        'Отлично, Андрей выбран. Двойной клик (тап) по клетке поставит его, одиночный — оставит метку-кандидата (о метках чуть позже).',
    ...
    },
    {
      ...
      text: [
        'Когда кандидат не один, ставят метки: клик (тап) по клетке — на ней появится маленькая метка цвета персонажа.',
    ...
    },
    {
      ...
      title: 'Метки Галины',
      text: [
        'Пометьте кликом (тапом) все три свободные клетки приёмной вне ковра: верхнюю клетку зоны и обе клетки нижнего ряда.',
      ],
    ...
    },
    {
      ...
      text: [
        ...
        'Если Галина в нижнем ряду, Владимиру нужен ряд ещё ниже — а его не существует! Значит, обе метки нижнего ряда ошибочны. Снимите их повторным кликом (тапом).',
      ],
    ...
    },
    {
      id: 'galina-place',
      title: 'Осталась одна',
      text: ['У Галины единственный вариант — верхняя клетка приёмной. Поставьте её двойным кликом (тапом).'],
    ...
    },
    {
      ...
      text: [
        ...
        'Снимите кликом (тапом) метку из нижнего ряда.',
      ],
