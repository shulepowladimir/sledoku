...
export const ItemLibrary = {
  ...
  // ——— Бойцовский клуб (40-fightclub) ———
  locker: item('locker', 'locker', 'decorative', 'Шкафчик'),
  ...
  saunaStove: item('saunaStove', 'saunaStove', 'decorative', 'Каменка'),
  washTub: item('washTub', 'washTub', 'decorative', 'Таз'),
  towel: item('towel', 'towel', 'decorative', 'Полотенце'),
  venik: item('venik', 'venik', 'decorative', 'Веник'),
  ...
  fireExtinguisher: item('fireExtinguisher', 'fireExtinguisher', 'decorative', 'Огнетушитель'),
